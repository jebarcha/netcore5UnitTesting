...
namespace Bongo.Models
{
    ...
    public class DateInFutureAttributeTests
    {
        ...
        public bool DateValidator_InputExpectedDateRange_DateValidity(int addTimeInSeconds)
        {
            DateInFutureAttribute dateInFutureAttribute = new(()=>DateTime.Now);

            return dateInFutureAttribute.IsValid(DateTime.Now.AddSeconds(addTimeInSeconds));
